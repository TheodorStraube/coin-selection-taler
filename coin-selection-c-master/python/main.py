...
from pulp_model import select_closest, select_generous, select_minimize_deposit_refresh, select_minimize_fee
...
def process_call(args):
    status, result = select_closest(args["amount"], args["wallet"])
